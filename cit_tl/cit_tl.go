...
//func NewcitTLCustomResourceDefinition(cs clientset.Interface) *apiextensionsv1beta1.CustomResourceDefinition {
func NewcitTLCustomResourceDefinition(cs clientset.Interface) error {
        crd := &apiextensionsv1beta1.CustomResourceDefinition{
                ObjectMeta: metav1.ObjectMeta{Name: "trusttabs.cit.intel.com"},
                Spec: apiextensionsv1beta1.CustomResourceDefinitionSpec{
                        ...
                        Names: apiextensionsv1beta1.CustomResourceDefinitionNames{
                                Plural:     "trusttabs",
                                Singular:   "trusttab",
                                //Kind:       reflect.TypeOf(tlclient.Trusttabs{}).Name(),
                                Kind:       "TrustTab",
                                ShortNames:  []string{"tt" },
                                //ListKind:   "trusttablist",
                        },
        ...
        if err != nil && apierrors.IsAlreadyExists(err) {
                fmt.Println("Cit TL CRD allready exsists")
                return nil
        }else {
		if err:= waitForEstablishedCRD(cs, crd.Name); err != nil {
                	fmt.Println("Failed to establish TL CRD ")
                	return err
		}
	}
			
        fmt.Println("sucessfully created CITTL CRD")
        return err
}
